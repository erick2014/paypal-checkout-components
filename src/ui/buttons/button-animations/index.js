...
import { setupFadeOutLogoAndShowLabelText } from './fadeout-logo-animation';
...
export function getButtonAnimation(personalization : ?Personalization) : ButtonAnimationOutputParams | Object {
    ...
    if (animationId === 'fadeout-logo-animation') {
        return setupFadeOutLogoAndShowLabelText(animationLabelText);
    }
